<nav>
    <a href="index.php"><img src="img/logo_long.png" alt="Logo personnel"></a>

    <ul>
        <li><a href="index.php#gototimeline">Parcours</a></li>
        <li><a href="index.php#competencesLink">Compétences</a></li>
        <li><a href="page_projets.php">Projets</a></li>
