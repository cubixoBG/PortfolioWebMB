                ...
                <div class="filter-container">
                    <form method="GET" action="">
                        ...
                        <select name="categorie" id="categorie" onchange="this.form.submit()">
                            ...
                            <option value="Programmation - Algorithmie" <?= (isset($_GET['categorie']) && $_GET['categorie'] == 'Programmation - Algorithmie') ? 'selected' : '' ?>>Programmation -
                                Algorithmie</option>
                            <option value="AudioVisuel" <?= (isset($_GET['categorie']) && $_GET['categorie'] == 'AudioVisuel') ? 'selected' : '' ?>>AudioVisuel</option>
                        </select>
                    </form>
                </div>
